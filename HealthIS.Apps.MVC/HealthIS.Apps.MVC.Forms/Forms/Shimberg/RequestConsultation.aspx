<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestConsultation.aspx.cs" Inherits="HealthIS.Apps.MVC.Forms.RequestConsultation" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:Panel CssClass="ContactForm" ID="pnlFormStart" runat="server">
                    <div class="req-consultation-form">
                        <p class="form-group"> 
                        ...
                        <p class="form-group">
                            <asp:Label ID="lblReason_for_Consultation" AssociatedControlID="tb_Reason_for_Consultation" runat="server" Text="What would you like to discuss during your consultation? *" /><br />
                            <asp:TextBox ID="tb_Reason_for_Consultation" runat="server" CssClass="form-control" placeholder="This will help us determine who can best assist you." TextMode="MultiLine" Rows="5"></asp:TextBox>                            
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="tb_Reason_for_Consultation" runat="server" ErrorMessage=""></asp:RequiredFieldValidator>
                        </p>
                        <p class="form-group">
                            <asp:Label ID="lblPreferred_Consultation_Method" AssociatedControlID="ddl_Preferred_Consultation_Method" runat="server" Text="Preferred Consultation Method" />
                             <asp:DropDownList ID="ddl_Preferred_Consultation_Method" runat="server" CssClass="form-control">
                                <asp:ListItem Text="Select" Value="no selection made"></asp:ListItem>
                                <asp:ListItem Text="In the library" Value="In the library"></asp:ListItem>
                                <asp:ListItem Text="Phone" Value="Phone"></asp:ListItem> 
                                <asp:ListItem Text="Email" Value="Email"></asp:ListItem>                                                               
                            </asp:DropDownList>                            
                        </p>
                        <h4>Requested appointment date and time</h4>
                ...
                <asp:Panel ID="pnlFormComplete" Visible="false" runat="server">
                    <p>Thank you, your consultation request has been sent successfully.<br />We'll get back to you within two (2) business days.</p>
