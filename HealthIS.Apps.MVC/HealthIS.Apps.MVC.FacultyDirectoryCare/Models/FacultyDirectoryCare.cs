...
{
    public class FacultyDirectoryCare
    {
        ...
        //
        public Person_Info SearchHD(string fname, string lname, string personIdFromList)
        {
            ...
            HealthIS.Apps.MVC.Models.Person_Info person = new HealthIS.Apps.MVC.Models.Person_Info();
            try
            {
        ...
        //
        public Person_Info LoadFacultyInfo(NameValueCollection allFaculties, string personId)
        {
            HealthIS.Apps.MVC.Models.Person_Info person = new HealthIS.Apps.MVC.Models.Person_Info();
            try
            {
                ...
                if (!personId.ToLower().Contains("temp_") && allFaculties.Count > 0)
                {
                    ...
                    {
                        Person_Info searchedData = SearchHD(person.FIRST_NAME, person.LAST_NAME, personId);
