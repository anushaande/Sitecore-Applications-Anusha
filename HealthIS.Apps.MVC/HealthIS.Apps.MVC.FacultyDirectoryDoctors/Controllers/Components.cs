...
namespace HealthIS.Apps.MVC.Controllers
{
    public class Components : Controller
    {
        ...
        public ActionResult FacultyDirectoryDoctors(string itemId, string key, string value, string type, string movementTo)
        {
            FacultyDirectoryDoctors facultyList = new FacultyDirectoryDoctors();
            ...
            if (Sitecore.Context.PageMode.IsExperienceEditor)
            {
                ...
                if (!String.IsNullOrEmpty(itemId) && type == "Add New Branch" && !String.IsNullOrEmpty(key))
                {
                    ...
                    string templatePath = "/sitecore/templates/Branches/Faculty Directory Doctors/Faculty Directory DB Section";
                    if (key == "DB Section")
                    {
                        templatePath = "/sitecore/templates/Branches/Faculty Directory Doctors/Faculty Directory DB Section";
                    }
                    else if (key == "Input Section")
                    {
                        templatePath = "/sitecore/templates/Branches/Faculty Directory Doctors/Faculty Directory Input Section";
                    }
                ...
                if (!String.IsNullOrEmpty(key) && type == "Add New Faculty")
                {
                    ...
                    if (key == "User Input")
                    {
                        ...
                        TemplateItem template = facultyList.item.Database.GetTemplate("User Defined2/Component Template/Faculty Directory Doctors/Faculty Directory Input View");
        ...
        public ActionResult FacultyDirectoryDoctorsProfile()
        {
            FacultyDirectoryDoctorsProfile facultyProfile = new FacultyDirectoryDoctorsProfile();
