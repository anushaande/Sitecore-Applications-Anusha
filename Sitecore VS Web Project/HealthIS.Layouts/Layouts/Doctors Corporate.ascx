...
<section role="banner" id="cloud-header">
    ...
    <div id="intro" class="clearfix">
        <sc:placeholder key="DoctorsHomeSS" runat="server"></sc:placeholder>
        
        <!-- Patient toolbox goes here -->
        <sc:placeholder key="DoctorsHomePT" runat="server"></sc:placeholder>
    </div>
</section>

<!-- THIS IS BAD. THIS SHOULD BE A USER FRIENDLY COMPONENT. -->
<nav role="navigation" class="navtacular navtacular-theme-simple container block-center">
...
<main role="main" class="container block-center site-content">
    <div class="bg-tab">
        <div class="row-fluid">
