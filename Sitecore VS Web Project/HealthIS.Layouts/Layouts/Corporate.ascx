...
<header role="banner" id="corp-header">
...
<main role="main" class="container block-center site-content tapered-underline">
    <!-- BEGIN_REPLACE|content -->
    <div class="clearfix">
        <sc:placeholder runat="server" key="CorporateMain"></sc:placeholder>
    </div>
    <!-- END_REPLACE|content -->
</main>
...
<footer role="contentinfo" id="corp-footer">
    <div class="container block-center">
        <div class="left">
