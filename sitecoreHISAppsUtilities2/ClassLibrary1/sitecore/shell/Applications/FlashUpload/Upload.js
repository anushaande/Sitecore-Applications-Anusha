var SitecoreMultiUpload = Class.create({
    ...
    error: function (event) {
        ...
        ///
        /// Uploaded by Jihyun Kim on 11/10/2016
        ///

        //scForm.postRequest("", "", "", "OnError"); // Original
        $("Message").setAttribute("style", "color:red; padding-left: 67px;"); 
        $("Message").innerHTML = "The file size exceeds max limit (" + $$('.uploadImageLimit')[0].value + ").";
    },
