...
RadEditorCommandList["ShortcutHelper"] = function (commandName, editor, args) {
...
//Set the Id of your button into the RadEditorCommandList[]
RadEditorCommandList["ButtonGenerator"] = function (commandName, editor, args) {
    var d = Telerik.Web.UI.Editor.CommandList._getLinkArgument(editor);
    Telerik.Web.UI.Editor.CommandList._getDialogArguments(d, "A", editor, "DocumentManager");
    ...
    var html = editor.getSelectionHtml();
    scEditor = editor;
    scEditor.pasteHtml("[[Text|Link|bg-usfGreen|True]]");
};

// Customized Image Tag to add Float-left class
RadEditorCommandList["FloatImageLeft"] = function (commandName, editor, args) {
    var d = Telerik.Web.UI.Editor.CommandList._getLinkArgument(editor);
    Telerik.Web.UI.Editor.CommandList._getDialogArguments(d, "A", editor, "DocumentManager");
    ...
    var html = editor.getSelectionHtml();
    scEditor = editor;
    if (!html.startsWith("<img ")) { alert("Please select an image to float to the left."); }
    html = html.replace("<img ", "<img class='float-image-left' ");
    scEditor.pasteHtml(html);
};

// Customized Image Tag to add Float-center class
RadEditorCommandList["FloatImageCenter"] = function (commandName, editor, args) {
    var d = Telerik.Web.UI.Editor.CommandList._getLinkArgument(editor);
    Telerik.Web.UI.Editor.CommandList._getDialogArguments(d, "A", editor, "DocumentManager");
    ...
    var html = editor.getSelectionHtml();
    scEditor = editor;
    if (!html.startsWith("<img ")) { alert("Please select an image to float to the center."); }
    html = html.replace("<img ", "<img class='float-image-center' ");
    scEditor.pasteHtml(html);
};

// Customized Image Tag to add Float-right class
RadEditorCommandList["FloatImageRight"] = function (commandName, editor, args) {
    var d = Telerik.Web.UI.Editor.CommandList._getLinkArgument(editor);
    Telerik.Web.UI.Editor.CommandList._getDialogArguments(d, "A", editor, "DocumentManager");
    ...
    var html = editor.getSelectionHtml();
    scEditor = editor;
    if (!html.startsWith("<img ")) { alert("Please select an image to float to the right."); }
    html = html.replace("<img ", "<img class='float-image-right' ");
    scEditor.pasteHtml(html);
};

// Customized Image Tag to set default float
RadEditorCommandList["RemoveImageFloat"] = function (commandName, editor, args) {
    var d = Telerik.Web.UI.Editor.CommandList._getLinkArgument(editor);
    Telerik.Web.UI.Editor.CommandList._getDialogArguments(d, "A", editor, "DocumentManager");
    ...
    var html = editor.getSelectionHtml();
    scEditor = editor;
    if (!html.startsWith("<img ")) { alert("Please select an image to remove image float."); }
...
RadEditorCommandList["InsertSitecoreMediaForBlog"] = function (commandName, editor, args) {
    var html = editor.getSelectionHtml();
    var id;
    ...
    editor.showExternalDialog(
      "/sitecore/shell/default.aspx?xmlcontrol=RichText.InsertImageForBlog&la=" + scLanguage + (id ? "&fo=" + id : "") + (scDatabase ? "&databasename=" + scDatabase : ""),
      null, //argument
      1105,
      700,
