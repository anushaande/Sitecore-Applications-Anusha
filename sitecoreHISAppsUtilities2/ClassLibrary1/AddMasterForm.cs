...
namespace Sitecore.Shell.Applications.WebEdit.Dialogs.AddMaster2
{
    class AddMasterForm : DialogForm
  {
    ...
    {
      string parentItemID = Sitecore.Shell.Applications.WebEdit.Commands.CreateNewPageItem.parentItemID;
